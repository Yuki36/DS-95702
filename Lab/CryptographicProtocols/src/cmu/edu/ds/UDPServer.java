...
public class UDPServer {
    ...
    public static void main(String[] args) {
        ...
        udpServer.init(7272);
        BigInteger valueA = new BigInteger(udpServer.receive());
        // System.out.println("Server received: " + valueA);
        ...
        BigInteger power = new BigInteger(2046, rdm);
        BigInteger valueB = base.modPow(power, p);
        udpServer.send(valueB.toString());
        BigInteger secret = valueA.modPow(power, p);
        System.out.println("The secret integer is: " + secret.toString());
        udpServer.close();
    }
