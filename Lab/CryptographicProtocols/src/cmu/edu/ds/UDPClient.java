...
public class UDPClient {
    ...
    public static void main(String[] args) {
        ...
        BigInteger valueA = base.modPow(power, p);
...
//        System.out.println("value = " + value);
        ...
        udpClient.send(valueA.toString());
        BigInteger valueB = new BigInteger(udpClient.receive());
        BigInteger secret = valueB.modPow(power, p);
